	...
	<div class="admin-content">
		...
		<div class="admin-biaogelist">
		    <div class="listbiaoti am-cf">
			    <ul class="am-icon-flag on"> 用户权限列表 </ul>
			</div>
			
			<div class="am-btn-toolbars am-btn-toolbar am-kg am-cf">
				<ul>
					<li style="margin-left: 10px; font-size: 14px; margin-top:2px;">权限名：</li>
					<li>
		        	...
		        	<table id="list_table" style="width:100%;" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
		            	<thead>
		            		<tr class="am-success">
				                ...
				                <th class="table-title">对象</th>
				                <th class="table-title">是否可修改</th>
		            	...
		            	<tbody>
		              		<tr>
				                ...
				                <td>1</td>
				                <td><a href="javascript:showDetailInfo();">测试权限</a></td>
				                <td>测试用户</td>
								<td>否</td>
								<td>启用</td>
								<td>测试权限可以修改</td>
		...
		<div class="am-modal am-modal-no-btn" id="add_popup">
			<div class="am-modal-dialog" style="width:45%; height:350px;overflow: auto">
		    	<div class="am-popup-hd">
	      			<h4 class="am-popup-title">添加权限</h4>
			    ...
			    <div class="am-popup-bd">
		      		<form class="am-form tjlanmu">
		        		<div class="am-form-group am-cf">
		          			...
		          			<div class="you">
		            			<input type="text" class="am-input-sm" id="add_manufacture" style="width:70%" placeholder="请输入权限名">
		          			</div>
		        		</div>
		        		<div class="am-form-group am-cf" >
		          			<div class="zuo">访问权限：</div>
		          			<div class="you">
		...
		<div class="am-modal am-modal-no-btn" id="update_popup">
			<div class="am-modal-dialog" style="width:45%; height:350px;overflow: auto">
		    	<div class="am-popup-hd">
	      			<h4 class="am-popup-title">修改权限</h4>
					<span data-am-modal-close class="am-close" style="color:blue;">&times;</span>
	    		</div>
			    <div class="am-popup-bd">
		      		<form class="am-form tjlanmu">
		...
		<div class="am-modal am-modal-no-btn" id="detail_popup">
			<div class="am-modal-dialog" style="width:45%; height:340px;overflow: auto">
		    	<div class="am-popup-hd">
	      			<h4 class="am-popup-title">权限详细信息</h4>
					<span data-am-modal-close class="am-close" style="color:blue;">&times;</span>
	    		</div>
			    <div class="am-popup-bd" >
		      		<form class="am-form tjlanmu">
		        		...
		        		<div class="am-form-group am-cf" style="margin-left:15%">
		          			<div class="zuo">对象：</div>
		          			<div class="you">
						                      测试用户
		          			</div>
		        		</div>
		        		<div class="am-form-group am-cf" style="margin-left:15%">
		          			<div class="zuo">是否可修改：</div>
		          			<div class="you">
		          				是
		          			</div>
		        		</div>
