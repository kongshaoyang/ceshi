	...
	<div class="admin-content">
		...
		<div class="admin-biaogelist">
		    <div class="listbiaoti am-cf">
			    <ul class="am-icon-flag on"> 二手服务商列表 </ul>
			</div>
			
			<div class="am-btn-toolbars am-btn-toolbar am-kg am-cf">
				<ul>
					<li style="margin-left: 10px; font-size: 14px; margin-top:2px; width: 11%">二手服务商名称：</li>
					<li>
		        	...
		        	<table id="list_table" style="width:100%;" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
		            	<thead>
		            		<tr class="am-success">
								...
								<th class="table-title">二手服务商名称</th>
		...
		<div class="am-modal am-modal-no-btn" id="add_popup">
			<div class="am-modal-dialog" style="width:50%; height:500px;overflow: auto">
		    	<div class="am-popup-hd">
	      			<h4 class="am-popup-title">添加二手服务商</h4>
			    ...
			    <div class="am-popup-bd">
		      		<form class="am-form tjlanmu">
		        		<div class="am-form-group am-cf" style="margin-left:10%">
		          			<div class="zuo">二手服务商名称：</div>
		          			<div class="you">
		            			<input type="text" class="am-input-sm" id="add_manufacture" style="width:70%" placeholder="请输入二手服务商名称">
		          			</div>
		        		</div>
		        		<div class="am-form-group am-cf" style="margin-left:10%">
		...
		<div class="am-modal am-modal-no-btn" id="detail_popup">
			<div class="am-modal-dialog" style="width:50%; height:480px;overflow: auto">
		    	<div class="am-popup-hd">
	      			<h4 class="am-popup-title">二手服务商详细信息</h4>
					<span data-am-modal-close class="am-close" style="color:blue;">&times;</span>
	    		</div>
			    <div class="am-popup-bd" >
		      		<form class="am-form tjlanmu">
		...
		<div class="am-modal am-modal-no-btn" id="update_popup">
			<div class="am-modal-dialog" style="width:50%; height:500px;overflow: auto">
		    	<div class="am-popup-hd">
	      			<h4 class="am-popup-title">修改二手服务商</h4>
					<span data-am-modal-close class="am-close" style="color:blue;">&times;</span>
	    		</div>
			    <div class="am-popup-bd">
		      		<form class="am-form tjlanmu">
