	...
	<div class="admin-content">
		...
		<div class="admin-biaogelist">
		    <div class="listbiaoti am-cf">
			    <ul class="am-icon-flag on"> 产品明细列表 </ul>
			</div>
			...
			<div class="am-btn-toolbars am-btn-toolbar am-kg am-cf">
				<ul>
					...
					<li style="margin-left: 10px; font-size: 14px; margin-top:2px;">产品批次：</li>
					<li>
						<input name="queryParams.productModel" type="text" class="am-form-field am-input-sm am-input-xm" style="width:128px;"/>
					</li>
					<li style="margin-left: 10px; font-size: 14px; margin-top:2px;">产品序列号：</li>
					<li>
			...
			<div class="am-btn-toolbars am-btn-toolbar am-kg am-cf">
				<ul>
					<li style="margin-left: 10px; font-size: 14px; margin-top:2px; width: 70px;">标签号码：</li>
					<li>
						<input name="queryParams.instruction" type="text" class="am-form-field am-input-sm am-input-xm" style="width:128px;"/>
					</li>
		        	...
		        	<table id="list_table" style="width:100%;" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
		            	<thead>
		            		<tr class="am-success">
				                ...
				                <th class="table-title">产品批次</th>
								<th class="table-title">产品序列号</th>
				                <th class="table-author am-hide-sm-only">标签号码</th>
		...
		<div class="am-modal am-modal-no-btn" id="detail_popup">
			<div class="am-modal-dialog" style="width:50%; height:440px; overflow: auto;">
		    	<div class="am-popup-hd">
	      			<h4 class="am-popup-title">产品详细信息</h4>
			    ...
			    <div class="am-popup-bd" >
		      		<form class="am-form tjlanmu">
				        ...
				        <div class="am-form-group am-cf" style="margin-left:15%">
		          			<div class="zuo">产品批次：</div>
		          			<div class="you">
		          				1002
		          			</div>
		        		</div>
				       <div class="am-form-group am-cf" style="margin-left:15%">
		          			<div class="zuo">产品序列号：</div>
		          			<div class="you">
		          				20151515
		          			</div>
		        		</div>
		...
		<div class="am-modal am-modal-no-btn" id="import_popup">
			<div class="am-modal-dialog" style="width:45%; height:180px;overflow: auto">
		    	<div class="am-popup-hd">
	      			<h4 class="am-popup-title">批量导入产品信息 </h4>
					<span data-am-modal-close class="am-close" style="color: blue;">&times;</span>
	    		</div>
			    <div class="am-popup-bd">
			      	<form class="am-form" >
			      		<div class="am-btn-toolbars am-btn-toolbar am-kg am-cf" style="margin-top: 50px;">
			        		<ul>
			        			...
			        			<li style="font-size: 14px;margin-top:3px">产品文件路径：</li>
