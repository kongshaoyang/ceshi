	...
	<div class="admin-content">
		...
		<div class="admin-biaogelist">
		    <div class="listbiaoti am-cf">
			    <ul class="am-icon-flag on">标签供应商列表 </ul>
			</div>
			...
			<div class="am-btn-toolbars am-btn-toolbar am-kg am-cf">
				<ul>
					...
					<li style="margin-left: 10px; font-size: 14px; margin-top:2px;">当前标签价格：</li>
					<li>
		        	...
		        	<table id="list_table" style="width:100%;" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
		            	<thead>
		            		<tr class="am-success">
				                ...
				                <th class="table-title">当前标签价格</th>
								<th class="table-title">累计标签数量</th>
				                <th class="table-author am-hide-sm-only">累计标签金额</th>
		...
		<div class="am-modal am-modal-no-btn" id="add_popup">
			<div class="am-modal-dialog" style="width:50%; height:380px;overflow: auto">
		    	<div class="am-popup-hd">
	      			<h4 class="am-popup-title">添加标签供应商</h4>
			    ...
			    <div class="am-popup-bd">
		      		<form class="am-form tjlanmu">
				        ...
				        <div class="am-form-group am-cf" style="margin-left:10%">
		          			<div class="zuo">当前标签价格：</div>
		          			<div class="you">
		            			<input type="text" class="am-input-sm" id="add_instruction" style="width:70%" placeholder="请输入当前标签价格">
		          			</div>
		        		</div>
				        <div class="am-form-group am-cf" style="margin-left:10%">
		...
		<div class="am-modal am-modal-no-btn" id="detail_popup">
			<div class="am-modal-dialog" style="width:50%; height:440px;overflow: auto">
		    	<div class="am-popup-hd">
	      			<h4 class="am-popup-title">标签供应商详细信息</h4>
					<span data-am-modal-close class="am-close" style="color:blue;">&times;</span>
	    		</div>
			    <div class="am-popup-bd" >
		      		<form class="am-form tjlanmu">
				        ...
				        <div class="am-form-group am-cf" style="margin-left:15%">
		          			<div class="zuo">累计标签数量：</div>
		          			<div class="you">
		          				200个
		          			</div>
		        		</div>
				       <div class="am-form-group am-cf" style="margin-left:15%">
		          			<div class="zuo">累计标签金额：</div>
		          			<div class="you">
		          				1010 元
		          			</div>
		        		</div>
		...
		<div class="am-modal am-modal-no-btn" id="update_popup">
			<div class="am-modal-dialog" style="width:50%; height:380px;overflow: auto">
		    	<div class="am-popup-hd">
	      			<h4 class="am-popup-title">修改标签供应商</h4>
					<span data-am-modal-close class="am-close" style="color:blue;">&times;</span>
	    		</div>
			    <div class="am-popup-bd">
		      		<form class="am-form tjlanmu">
