	...
	<div class="admin-content">
		...
		<div class="admin-biaogelist">
		    <div class="listbiaoti am-cf">
			    <ul class="am-icon-flag on"> 知识列表</ul>
			</div>
			<div class="am-btn-toolbars am-btn-toolbar am-kg am-cf">
				<ul>
					...
					<li style="margin-left: 10px; font-size: 14px; margin-top:2px;">知识类型：</li>
		...
		<div class="am-modal am-modal-no-btn" id="add_popup">
			<div class="am-modal-dialog" style="width:550px;height:255px;overflow: auto">
		    	<div class="am-popup-hd">
	      			<h4 class="am-popup-title">添加知识库</h4>
		...
		<div class="am-modal am-modal-no-btn" id="detail_popup">
			<div class="am-modal-dialog" style="width:550px;height:170px;overflow: auto">
		    	<div class="am-popup-hd">
	      			<h4 class="am-popup-title">知识库详细信息</h4>
					<span data-am-modal-close class="am-close" style="color: blue;">&times;</span>
	    		</div>
			    <div class="am-popup-bd">
			      	<form class="am-form tjlanmu">
		        		<div class="am-form-group am-cf">
		        			<span style="text-align: center;">跳转到厂商总表页面</span>
		        		</div>
				        <div>
